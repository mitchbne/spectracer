...
# We expect the SPEC_DEPENDENCY_OUTPUTS_DIRECTORY to contain gzipped JSON files with the dependencies of each spec file.
...
module Spectacle
  class DependencyCollector
    ...
    def collect!
      ...
      write_object_to_gzipped_json(@inverse_spec_dependencies, OUTPUT_FILE_PATH)
